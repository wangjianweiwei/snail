...
<template>
  <v-app id="inspire" :style="`--v-global-theme-primary: ${hexToRgb(global.current.value.colors.primary)}`">
    <v-app-bar class="border-b-sm" height="48">
      <v-container fluid class="pa-12">
        <div class="d-flex justify-space-between">
          <div style="display: flex;align-items: center">
            <v-btn style="text-transform: none" prepend-icon="$vuetify" variant="plain" color="" size="x-large"><h4>By Vuetifyjs</h4></v-btn>
          </div>
    ...
    <v-app-bar class="border-b-sm">
      <v-container fluid class="pa-12">
        ...
        >
          ...
          <v-list density="compact" border="xs" rounded width="200px">
            <v-list-item
              class="mx-2"
              rounded="lg"
